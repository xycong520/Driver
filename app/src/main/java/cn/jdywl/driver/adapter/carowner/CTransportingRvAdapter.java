 ...
 */
public class CTransportingRvAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final String TAG = LogHelper.makeLogTag(CTransportingRvAdapter.class);
     ...
     */
    public CTransportingRvAdapter(List<OrderItem> dataSet) {
        mDataSet = dataSet;
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        dataHolder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent it = new Intent(context, CDetailActivity.class);
        ...
        dataHolder.tvOrderno.setText(data.getOrderNo());
        dataHolder.tvMarketprice.setText("市场运价: " + data.getDriverBill() + "元");
        dataHolder.tvBill.setText("成交运价: " + data.getBill() + "元");

        dataHolder.tvLocation.setText(data.getLocation());
