 ...
 */
public class STransportingRvAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final String TAG = LogHelper.makeLogTag(STransportingRvAdapter.class);
     ...
     */
    public STransportingRvAdapter(List<StageOrderItem> dataSet) {
        mDataSet = dataSet;
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        dataHolder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                it.putExtras(bundle);
                it.putExtra("from", StageOrderInfoActivity.FROM_STRANSPORTING);
