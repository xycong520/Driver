...
public class COrderRvAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     */
    public COrderRvAdapter(List<OrderItem> dataSet, int from) {
        mDataSet = dataSet;
        this.from = from;
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        if (data.getCarNum() < ApiConfig.CAR_SIZE) {
            ...
            dataHolder.tvExpprice.setText(String.format(Locale.CHINA, "竞拍价: %d元", data.getExpectationPrice()));
        ...
        switch (srv) {
            ...
            case AddOrderFragment.SRV_REGULATORY:
                dataHolder.tvSrvtype.setVisibility(View.VISIBLE);
                dataHolder.tvSrvtype.setText("代收车款");
                break;
            default:
                dataHolder.tvSrvtype.setVisibility(View.INVISIBLE);
                break;
        }
    }
