...
public class STodosFragment extends BaseFragment implements
        SwipeRefreshLayout.OnRefreshListener {

    private static String TAG = LogHelper.makeLogTag(STodosFragment.class);
     ...
     */
    public static STodosFragment newInstance() {
        return new STodosFragment();
    }

    public STodosFragment() {
