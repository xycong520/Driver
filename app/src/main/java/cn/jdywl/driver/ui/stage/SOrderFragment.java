 ...
 */
public class SOrderFragment extends BaseFragment implements
        SwipeRefreshLayout.OnRefreshListener {

    private static String TAG = LogHelper.makeLogTag(SOrderFragment.class);
     ...
     */
    public static SOrderFragment newInstance() {
        return new SOrderFragment();
    }
