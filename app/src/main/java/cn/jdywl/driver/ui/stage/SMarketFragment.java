 ...
 */
public class SMarketFragment extends BaseFragment implements
        SwipeRefreshLayout.OnRefreshListener {

    private static String TAG = LogHelper.makeLogTag(SMarketFragment.class);
     ...
     */
    public SMarketFragment() {
    }

    public static SMarketFragment newInstance() {
        return new SMarketFragment();
    }
