...
public class DMainActivity extends BaseActivity {
    ...
    public static final String REFRESH_ACTION = "DRefreshAction";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!AppConfig.isLogin()) {
            Intent it = new Intent(DMainActivity.this, LoginActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == LoginActivity.LOGIN) {
            ...
            if (resultCode == RESULT_OK) {
                //登录成功
                Toast.makeText(DMainActivity.this, "登录成功", Toast.LENGTH_SHORT).show();
                return;
            }
        }
