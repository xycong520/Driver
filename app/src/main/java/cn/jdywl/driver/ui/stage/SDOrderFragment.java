 ...
 * Use the {@link SDOrderFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SDOrderFragment extends BaseFragment implements
        SwipeRefreshLayout.OnRefreshListener {

    private static String TAG = LogHelper.makeLogTag(SDOrderFragment.class);
     ...
     */
    public static SDOrderFragment newInstance() {
        return new SDOrderFragment();
    }

    public SDOrderFragment() {
