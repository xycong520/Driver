 ...
 */
public class CarStageFragment extends BaseFragment implements
        SwipeRefreshLayout.OnRefreshListener {

    private static String TAG = LogHelper.makeLogTag(CarStageFragment.class);
     ...
     */
    public CarStageFragment() {
    }

    public static CarStageFragment newInstance() {
        return new CarStageFragment();
    }
...
//                        mData.add(response);
                        ...
                        Log.i("CarStageFragment",mData.getData().size()+"");
