...
public class DHistoryActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadData() {
        ...
        String url = ApiConfig.api_url + ApiConfig.DRIVER_HISTORY_URL +
        ...
        GsonRequest<OrderPage> myReq = new GsonRequest<OrderPage>(Request.Method.GET,
                ...
                new Response.Listener<OrderPage>() {
                    ...
                    public void onResponse(OrderPage response) {
                        ...
                        if (response.getTotal() == 0) {
                            Toast.makeText(DHistoryActivity.this, "历史订单为空", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Helper.processVolleyErrorMsg(DHistoryActivity.this, error);
                    }
                });
