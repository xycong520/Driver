 ...
 * Use the {@link DHistoryOrderFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class DHistoryOrderFragment extends BaseFragment implements
        SwipeRefreshLayout.OnRefreshListener {

    private static String TAG = LogHelper.makeLogTag(DHistoryOrderFragment.class);
     ...
     */
    public static DHistoryOrderFragment newInstance() {
        return new DHistoryOrderFragment();
    }

    public DHistoryOrderFragment() {
    ...
    private void setupRecyclerView(RecyclerView recyclerView) {
        ...
        //设置adapter
        mAdapter = new DOrderRvAdapter(mData.getData(), DOrderRvAdapter.FROM_SHISTORY_ORDER);
    ...
    private void loadData() {
        ...
        String url = ApiConfig.api_url + ApiConfig.SDRIVERS_DRIVER_HISTRY_URL +
