 ...
 * Use the {@link SHistoryOrderFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SHistoryOrderFragment extends BaseFragment implements
        SwipeRefreshLayout.OnRefreshListener {

    private static String TAG = LogHelper.makeLogTag(SHistoryOrderFragment.class);
    ...
    protected SOrderRvAdapter mAdapter;
     ...
     */
    public static SHistoryOrderFragment newInstance() {
        return new SHistoryOrderFragment();
    }

    public SHistoryOrderFragment() {
