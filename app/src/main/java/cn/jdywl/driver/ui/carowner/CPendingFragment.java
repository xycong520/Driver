 ...
 * <p/>
 */
public class CPendingFragment extends BaseFragment implements
        SwipeRefreshLayout.OnRefreshListener {

    //设置tag，用于在activity stop时取消Volley的请求
    public static final String TAG = LogHelper.makeLogTag(CPendingFragment.class);
     ...
     */
    public CPendingFragment() {
    }

    public static CPendingFragment newInstance() {
        return new CPendingFragment();
    }
